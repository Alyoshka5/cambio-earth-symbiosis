...
## Target Audience
The target audience for our web application is the 600-800 Cambio Earth Systems employees who attend the company’s Annual General Meeting.
...
Before attending the event, users will be able to view how far the venue is from their current location and how long it would take to get there. This will help all event attendees to plan accordingly and arrive at the event on time without having to manually check a map service.
